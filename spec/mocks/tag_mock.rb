...
class TagMock < ActiveMocker::Base
  ...
  class << self
    ...
    def types
      @types ||= ActiveMocker::HashProcess.new({ id: Integer, tagged_id: Integer, tagged_type: String, name: String, created_at: DateTime, updated_at: DateTime }, method(:build_type)).merge(super)
    end
